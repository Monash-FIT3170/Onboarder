...
const generateRowFunction = (
  ...
  const handleDeleteOrLeave = async (u_role: string, user_id: number, team_id: number) => {
    if (u_role === "Owner") {
        // Delete Team
        try {
              ...
              <TableRow key={result.id} sx={{ "&:last-child td, &:last-child th": { border: 0 } }}>
                  ...
                  <TableCell>
                      ...
                      <Button
                          ...
                          onClick={() => handleView(result.id, result.student_team_name, result.user_team_role)}
                      >
                          View Details
                      </Button>
                  </TableCell>
              ...
              <Box sx={modalStyle}>
                  {modalData && (
                      <>
                          ...
                          <Typography sx={{ mt: 2 }}>
                              Are you sure you want to delete the team "{modalData.student_team_name}"?<br></br>
                          ...
                          <Button variant="contained" color="error" onClick={() => {
                              ...
                              handleDeleteOrLeave(modalData.user_team_role, authStore.user, modalData.student_team_id);
                              handleCloseModal();
                          }} sx={{ mt: 2, ml: 2 }}>
                              Delete
                          </Button>
              ...
              <Box sx={modalStyle}>
                  {modalData && (
                      <>
                          ...
                          <Typography sx={{ mt: 2 }}>
                              Are you sure you want to leave the team "{modalData.student_team_name}"?
                          </Typography>
                          <Button variant="contained" onClick={handleCloseModal} sx={{ mt: 2 }}>
                              Cancel
                          </Button>
