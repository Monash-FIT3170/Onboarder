...
import { DashboardTable, StudentTeamResultProps } from "../components/DashboardTable";
...
const Dashboard: React.FC = () => {
    ...
    const handleSubmitTeam = async (teamName: string, teamDescription: string) => {
        try {
            ...
            await axios.post(`http://127.0.0.1:3000/student-team/${newTeamId}/members`, {
                email: user.email,
                role: "O",
            });
