...
const generateSkeletons = (rowCount, cellCount, includeViewButton = false) => {
            ...
            <Table style={styles.table} stickyHeader>
              ...
              <TableBody>
                {loading
                  ...
                  : <RecruitmentTable
                      data={data.filter((item) => item.status != "R")}
            ...
            <Table style={styles.table} stickyHeader>
              ...
              <TableBody>
                {loading
                  ...
                  : <RecruitmentTable
                      data={data.filter((item) => item.status == "R").slice(0, SHOW_ARCHIVED_AMOUNT)}
...
// 	rowCount: number,
// 	cellCount: number,
// 	includeViewButton: boolean = false
// ) => {
// 	return Array.from(new Array(rowCount)).map((_, rowIndex) => (
// 		<TableRow key={skeleton-row-${rowIndex}}>
// 			{Array.from(new Array(cellCount)).map((_, cellIndex) => (
...
// 							<h4>
// 								Current Recruitment Rounds: Showing{" "}
// 								{data.filter((item: any) => item.status == "I" || item.status == "R").length}
// 							</h4>
// 						</Grid>
// 						<Grid item>
// 							<Link to="/addrecruitmentround" style={{ textDecoration: "none" }}>
...
// 														<TableCell>
// 															{Status[item.status as keyof typeof Status] || "Unknown Status"}
// 														</TableCell>
